...
python3 multi_chain_bnn.py --gpu -p "(1000022, 1000022)" --epochs 2500 --batch 32 --burn 1000 --kernel nuts --results 10000 --chains 10 --skip 10 --arch "[5, 20, 20, 1]" --act "tanh" --leapfrog 512
