...
for burn in 0 32 64 128 256 512 1024 2048 4096 8192
do
	python3 timing_nuts.py --gpu -p "(1000022, 1000022)" --epochs 2500 --batch 32 --burn ${burn} --kernel hmc --results 1000 --chains 1 --skip 10 --arch "[5, 20, 20, 1]" --act "tanh" --leapfrog 512
done
