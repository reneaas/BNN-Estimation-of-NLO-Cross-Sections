...
python3 train_models.py --train --gpu -p "(1000022, 1000022)" -f "models/4_small_hidden_layers.npz" --epochs 1000 --batch 32 --burn 2500 --kernel nuts --results 1000 --chains 1 --skip 10 --trace --arch "[5, 20, 20, 20, 20, 1]" --act "tanh"
