...
do
	python3 timing_hmc.py --gpu -p "(1000022, 1000022)" --epochs 2500 --batch 32 --burn 1000 --kernel hmc --results 1000 --chains 1 --skip 10 --arch "[5, ${nodes}, 1]" --act "tanh" --leapfrog 512
done
