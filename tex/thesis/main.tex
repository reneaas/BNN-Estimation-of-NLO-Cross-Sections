...
\chapter{The Physics Problem}\label{chap:physics_problem}
\input{Sections/methods/physics_problem}
...
\input{Sections/methods/bayesian_ml}
...
\input{Sections/Experiments/methodology}
